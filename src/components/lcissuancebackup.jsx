    ...
    <form onSubmit={handleSubmit}>
      <div className="form-container">
        ...
        <div className="progress-bar-container">
          <ul className="flex justify-between w-full max-w-xl mx-auto">
            <li className="step active">
              <a href="#applicant_details">Applicant details</a>
            </li>
            <li className="step">
              <a href="#beneficiary_details">Beneficiary details</a>
            </li>
            <li className="step">
              <a href="#lc_details">LC details</a>
            </li>
            <li className="step">
        ...
        <div
          ...
          className="form-section mb-8 bg-gray-100 p-6 rounded-lg shadow-md"
        >
          {/* Section Title */}
          <h3 className="form-section-title text-lg font-semibold text-gray-800 mb-4">
            APPLICANT NAME AND ADDRESS
          </h3>
        ...
        <div id="beneficiary_details" className="form-section">
        ...
        <div id="lc_details" className="form-section flex-row">
          ...
          <div className="form-section-item">
            ...
            >
              <input
                ...
                id="teleTransmission"
                name="transmission"
                onChange={(e) => setCustomByTeleTransmission(e.target.checked)}
              />
              <label
          ...
          <div className="form-field-contailer">
            <div className="form-radio-group">
              <input
                ...
                id="sight"
                name="paymentTerms"
                onChange={(e) => setCustomSight(e.target.value)}
              />
              ...
              <input
                ...
                id="usance"
                name="paymentTerms"
                onChange={(e) => setCustomUsance(e.target.value)}
              />
            ...
            <div className="form-radio-group">
              <input
                ...
                id="mixedPayment"
                name="paymentTerms"
                onChange={(e) => setCustomMixedPayment(e.target.value)}
              />
              ...
              <input
                ...
                id="deferredPayment"
                name="paymentTerms"
                onChange={(e) => setCustomDifferedPayment(e.target.value)}
              />
          ...
          <div className="form-section-item">
            ...
            <div className="form-field">
              ...
              <input
                ...
                onChange={(e) =>
                  setCustomPlaceOfFinalDestination(e.target.value)
                }
              />
            </div>
          </div>
          ...
          <div className="input-row flex-row">
            ...
            <div className="form-field">
              ...
              <input
                ...
                onChange={(e) =>
                  setCustomDocumentPresentationPeriod(e.target.value)
                }
              />
            </div>
        ...
        <div className="form-section">
          ...
          <div className="form-field">
            ...
            <input
              ...
              onChange={(e) =>
                setCustomDescriptionSpecificationAndQuantity(e.target.value)
              }
            />
          </div>
          ...
          <div className="form-row flex-row">
            <div className="form-field">
              ...
              <input
                type="text"
                className="form-input"
                onChange={(e) => setCustomAsPerInvoiceNumber(e.target.value)}
              />
            </div>
            <div className="form-field">
              ...
              <input
                type="date"
                className="form-input"
                onChange={(e) => setCustomDated(e.target.value)}
              />
            </div>
            <div className="form-field">
              ...
              <input
                type="text"
                className="form-input"
                onChange={(e) => setCustomMasterGoods(e.target.value)}
              />
            </div>
            ...
            <div className="form-field">
              ...
              <input
                type="text"
                className="form-input"
                onChange={(e) => setCustomSelectedCode(e.target.value)}
              />
            </div>
            <div className="form-field">
        ...
        2{/* Authorized to Debit Our Account */}
        <div className="form-section">
          <h3 className="form-section-title">
            ...
            <div className="document-form-field">
              ...
              <label>
                ...
                <input
                  type="number"
                  className="form-input"
                  onChange={(e) => setCustomCeroriginNoOfCopies(e.target.value)}
                />{" "}
                Copy/ies
              </label>
            </div>
        ...
        <div className="form-group">
          ...
          <div className="form-section-container flex-row">
            ...
            <div className="file-upload-row">
              ...
              <input
                type="file"
                onChange={(e) => setCustomBibini(e.target.value)}
              />
            </div>
          </div>
        </div>
        ...
        <div className="form-group">
          ...
          <input
            type="text"
            className="full-width form-input"
            onChange={(e) => setCustomAdvisingBankDetails(e.target.value)}
          />
